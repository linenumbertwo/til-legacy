...
## 25일
- 정처기 기출문제 풀면서 진수 변환, 논리회로, 진리표 등 이론 공부도 했슴
	> 고등학교 때 배웠던 내용이라 금방 익힐 수 있었음
- 정처기 문제 유형 중, SQL쪽은 다 맞았지만 PC운영체제(MS-DOS, 윈도 98 등)는 거의 다 틀렸음..매우 어렵
- 영어 작문, 단어 암기, 리스닝 공부를 했음
